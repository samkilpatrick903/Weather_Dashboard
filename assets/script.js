...
function getWeather(cityName) {
    var request5Day = `https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&appid=${apiKey}`;
    ...
    fetch (request5Day) 
        ...
        function currentWeather(cityLat, cityLon) {
                console.log(cityLat);
                var requestWeather = `https://api.openweathermap.org/data/2.5/forecast?q=${cityName}&appid=${apiKey}`;
